...
Intuition behind weights: Lagrange multipliers to enforce a constraint... Notion ofR feature relevance. But does $\lambda_1>\lambda_2$ imply that $z_1$ is more relevant than $z_2$? 

Game theoretic interpretation \cite{Grunwald-04}.

The dual function amounts to the famous cross-entropy.
