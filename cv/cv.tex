...
\nopagebreak
\begin{itemize}
\item Leading development of algorithms for automated generation of high-fidelity digital humans from photos. {\em Keywords:} facial reconstruction, ``deep face'', animation retargetting, image enhancement.
\end{itemize}
\ \\
