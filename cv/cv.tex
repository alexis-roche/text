...
\bighead{COMPUTER VISION \& ARTIFICIAL INTELLIGENCE TEAM LEADER}{Didimo, Porto, Portugal}{2019--present}
\nopagebreak
\begin{itemize}
\item Developing computer vision and machine learning algorithms for high-fidelity 3D avatars.
\end{itemize}
\ \\
...
\begin{minipage}{.85\textwidth}
{\tiny$\bullet$} C/C++ \\
{\tiny$\bullet$} Python (numpy, scipy, pylab, skimage, opencv, sklearn, TensorFlow, Keras, ...)\\
...
{\tiny$\bullet$} Google scholar statistics: 6396 citations, h-index: 35, i10-index: 64 (September 2020).\\
