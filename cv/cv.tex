...
\noindent Hands-on technical team leader, applied researcher and engineer at heart, PhD, with a specialist expertise in computer vision and artificial intelligence. Has operated in public research and private R\&D in various fields (healthcare, electro-domestic, entertainment). Strong experience in the development of both open source and commercial software. {\em Keywords:} applied mathematics, statistics, machine learning, computer vision, computer graphics, computer-aided diagnosis, smart appliances, digital avatars, Python, C.
...
\ \\
\noindent \textbf{SCIENTIFIC REPORTING:} Author of more than 100 peer-reviewed scientific articles published in international journals, proceedings and books, and 6 published international patents.
...
\nopagebreak
\begin{itemize}
\item Leading development of generation pipeline of high-fidelity avatars from photos. {\em Keywords:} facial reconstruction, deep face, animation retargeting, image processing. Accepted talk at SIGGRAPH'22.
\end{itemize}
\ \\
...
\nopagebreak
\begin{itemize}
\item Led algorithmic development of computer-aided diagnosis software (released by Siemens Healthineers as part of the {\em AI-Rad Companion} solution) using brain morphometry for radiological reading. {\em Keywords:} magnetic resonance imaging (MRI), brain image segmentation, disease classification, neurodegeneration, Alzheimer's disease.
